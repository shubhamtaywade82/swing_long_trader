...
| `app/models/watchlist_item.rb`              | `app/models/watchlist_item.rb`              | **MODIFY** - Remove derivative enum value  |
| `app/models/setting.rb`                     | `app/models/setting.rb`                     | **NEW** - Required for importer statistics |
| `app/models/instrument_type_mapping.rb`     | `app/models/instrument_type_mapping.rb`     | **OPTIONAL** - Only if needed              |
...
| Source                                  | Destination                             | Notes                                           |
| --------------------------------------- | --------------------------------------- | ----------------------------------------------- |
| `app/services/instruments_importer.rb`  | `app/services/instruments_importer.rb`  | **REWRITE** - See SWING_CLEAN_IMPORTER_GUIDE.md |
| `app/models/setting.rb`                 | `app/models/setting.rb`                 | **NEW** - Required for importer statistics      |
...
| `db/migrate/YYYYMMDDHHMMSS_create_settings.rb`        | `db/migrate/YYYYMMDDHHMMSS_create_settings.rb`        | Copy structure, regenerate timestamp                                         |
| `db/migrate/YYYYMMDDHHMMSS_create_watchlist_items.rb` | `db/migrate/YYYYMMDDHHMMSS_create_watchlist_items.rb` | Copy structure, regenerate timestamp (MODIFY - remove derivative references) |
...
| `config/universe/master_universe.yml` | NSE index constituents whitelist (generated) |
| `config/universe/csv/*.csv`           | NSE index CSV files (downloaded)             |

### New Rake Tasks

| New File                  | Purpose                                   |
| ------------------------- | ----------------------------------------- |
| `lib/tasks/universe.rake` | Build master universe from NSE index CSVs |
