...
module Dhan
  ...
  class Orders < ApplicationService
    def self.place_order(instrument:, order_type:, transaction_type:, quantity:, price: nil, trigger_price: nil,
                         client_order_id: nil, dry_run: false)
      new(
    ...
    def initialize(instrument:, order_type:, transaction_type:, quantity:, price: nil, trigger_price: nil,
                   client_order_id: nil, dry_run: false)
      @instrument = instrument
    ...
    def send_order_failure_alert(order, error_msg)
      return unless AlgoConfig.fetch(%i[notifications telegram notify_errors])
    ...
    def generate_client_order_id
      return nil if @instrument&.security_id.blank?
