...
module Screeners
  class LongtermScreener < ApplicationService
    ...
    def persist_result(analysis)
      ...
      # Remove any forbidden fields (setup_status, accumulation_plan, recommendation, etc.)
      ...
      clean_metadata.delete(:accumulation_conditions)
    ...
    def analyze_instrument(instrument)
      ...
      # SCREENER CONTRACT: Only candidate generation data, no setup status, no accumulation plans, no recommendations
      {
      ...
      # SCREENER CONTRACT: Setup classification and accumulation planning happen in later layers
      # - LongtermSetupDetector is called by TradeQualityRanker or SetupClassifier service
      # - LongtermTradePlanBuilder is called by TradePlanner service
