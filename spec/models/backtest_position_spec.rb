...
RSpec.describe BacktestPosition do
  ...
  describe "scopes" do
    it "long scope returns long positions" do
      ...
      long_positions = described_class.long
    ...
    it "short scope returns short positions" do
      ...
      short_positions = described_class.short
    ...
    it "closed scope returns closed positions" do
      ...
      closed_positions = described_class.closed
    ...
    it "open scope returns open positions" do
      ...
      open_positions = described_class.open
