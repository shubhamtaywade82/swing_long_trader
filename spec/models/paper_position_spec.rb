...
RSpec.describe PaperPosition do
  ...
  describe "scopes" do
    it "filters by open status" do
      ...
      expect(described_class.open).to include(open_pos)
      expect(described_class.open).not_to include(closed_pos)
    end
    ...
    it "filters by direction" do
      ...
      expect(described_class.long).to include(long_pos)
      expect(described_class.long).not_to include(short_pos)
      expect(described_class.short).to include(short_pos)
      expect(described_class.short).not_to include(long_pos)
    end
  end
  ...
  describe "scopes" do
    it "filters recent positions" do
      ...
      recent = described_class.recent.limit(1)
