...
RSpec.describe CandleSeriesRecord do
  ...
  describe ".latest_for" do
    it "finds latest for instrument and timeframe" do
      ...
      found = described_class.latest_for(instrument: instrument, timeframe: "1D")
  ...
  describe "scopes" do
    it "filters by instrument" do
      ...
      filtered = described_class.for_instrument(instrument1)
    ...
    it "filters by timeframe" do
      ...
      filtered = described_class.for_timeframe(:daily)
      expect(filtered).to include(candle1)
      expect(filtered).not_to include(candle2)
    end
    ...
    it "filters by date range" do
      ...
      filtered = described_class.between_dates(from_date, to_date)
      expect(filtered).to include(candle1)
      expect(filtered).not_to include(candle2)
  ...
  describe "edge cases" do
    ...
    it "handles latest_for with different timeframe" do
      ...
      found = described_class.latest_for(instrument: instrument, timeframe: "1W")
