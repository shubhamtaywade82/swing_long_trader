...
RSpec.describe PaperLedger do
  ...
  describe "scopes" do
    it "filters by transaction type" do
      ...
      expect(described_class.credits).to include(credit)
      expect(described_class.credits).not_to include(debit)
      expect(described_class.debits).to include(debit)
      expect(described_class.debits).not_to include(credit)
    end
  end
