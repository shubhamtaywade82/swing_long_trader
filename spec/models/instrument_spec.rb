  ...
  describe "class methods" do
    describe ".segment_key_for" do
      it "returns correct segment for known codes" do
        expect(described_class.segment_key_for("E")).to eq("equity")
        expect(described_class.segment_key_for("I")).to eq("index")
        expect(described_class.segment_key_for("D")).to eq("derivatives")
      end

      it "handles unknown segment codes" do
        expect(described_class.segment_key_for("UNKNOWN")).to be_nil
      end

      it "handles nil segment code" do
        expect(described_class.segment_key_for(nil)).to be_nil
      end
    end
  end
end
