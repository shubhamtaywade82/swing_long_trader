...
RSpec.describe OptimizationRun, type: :model do
  let(:run) do
  ...
  describe 'scopes' do
    it 'filters by status' do
      ...
      expect(OptimizationRun.completed).to include(completed)
      expect(OptimizationRun.completed).not_to include(pending)
    end
    ...
    it 'filters by strategy_type' do
      ...
      expect(OptimizationRun.swing).to include(swing)
      expect(OptimizationRun.swing).not_to include(long_term)
    end
  end
