  ...
  describe '#call' do
    ...
    context 'with edge cases' do
      ...
      it 'handles entry condition with momentum score requirement' do
        ...
        allow(daily_series).to receive(:ema).and_return(100.0)
        allow(daily_series).to receive(:rsi).and_return(40.0) # Low RSI
        allow(daily_series).to receive(:adx).and_return(15.0) # Low ADX
        allow(weekly_series).to receive(:ema).and_return(100.0)
        allow(weekly_series).to receive(:rsi).and_return(40.0)
        allow(weekly_series).to receive(:adx).and_return(15.0)
    ...
    describe 'private methods' do
      ...
      describe '#calculate_indicators' do
        it 'calculates all indicators' do
          allow(daily_series).to receive(:ema).and_return(100.0)
          allow(daily_series).to receive(:rsi).and_return(65.0)
          allow(daily_series).to receive(:adx).and_return(25.0)
      ...
      describe '#calculate_momentum_score' do
        it 'calculates momentum score based on RSI and ADX' do
          allow(daily_series).to receive(:ema).and_return(100.0)
          allow(daily_series).to receive(:rsi).and_return(65.0) # > 50
          allow(daily_series).to receive(:adx).and_return(25.0) # > 20
          allow(weekly_series).to receive(:ema).and_return(100.0)
          allow(weekly_series).to receive(:rsi).and_return(60.0) # > 50
          allow(weekly_series).to receive(:adx).and_return(22.0) # > 20
        ...
        it 'handles nil indicators' do
          allow(daily_series).to receive(:ema).and_return(100.0)
          allow(daily_series).to receive(:rsi).and_return(nil)
          allow(daily_series).to receive(:adx).and_return(nil)
          allow(weekly_series).to receive(:ema).and_return(100.0)
          allow(weekly_series).to receive(:rsi).and_return(nil)
          allow(weekly_series).to receive(:adx).and_return(nil)
        ...
        it 'handles indicators below thresholds' do
          allow(daily_series).to receive(:ema).and_return(100.0)
          allow(daily_series).to receive(:rsi).and_return(40.0) # < 50
          allow(daily_series).to receive(:adx).and_return(15.0) # < 20
          allow(weekly_series).to receive(:ema).and_return(100.0)
          allow(weekly_series).to receive(:rsi).and_return(45.0) # < 50
          allow(weekly_series).to receive(:adx).and_return(18.0) # < 20
