...
RSpec.describe Telegram::Notifier, type: :service do
  ...
  before do
    ...
    allow(Telegram::AlertFormatter).to receive(:format_signal_alert).and_return('Formatted message')
    allow(Telegram::AlertFormatter).to receive(:format_daily_candidates).and_return('Formatted candidates')
    allow(Telegram::AlertFormatter).to receive(:format_exit_alert).and_return('Formatted exit')
    allow(Telegram::AlertFormatter).to receive(:format_portfolio_snapshot).and_return('Formatted portfolio')
    allow(Telegram::AlertFormatter).to receive(:format_error_alert).and_return('Formatted error')
  end
